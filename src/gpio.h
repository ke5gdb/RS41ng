...
#define	GPS_RESET_N	GPIO_PIN_9
#define GPS_USART_IRQ	USART1_IRQn
#define GPS_USART_IT	USART1
#define APBPERIPHERAL_USART	RCC_APB2Periph_USART1
#define GPS_USART_IRQ_HANDLER	USART1_IRQHandler
...
// External serial always on USART3 (PB10/PB11) for RS41
#define BANK_EXT_USART_TX	GPIOB
#define PIN_EXT_USART_TX	GPIO_PIN_10
#define BANK_EXT_USART_RX	GPIOB
#define PIN_EXT_USART_RX	GPIO_PIN_11
#define EXT_USART		USART3
...
// Analog switch control (U201-U204)
#define BANK_SPST1	GPIOB
#define PIN_SPST1	GPIO_PIN_3
...
#define BANK_SPDT1	GPIOC
#define PIN_SPDT1	GPIO_PIN_10
#define BANK_SPDT2	GPIOC
#define PIN_SPDT2	GPIO_PIN_11
...
#define	GPS_RESET_N	GPIO_PIN_15
#define GPS_USART_IRQ	USART1_IRQn
#define GPS_USART_IT	USART1
#define APBPERIPHERAL_USART	RCC_APB2Periph_USART1
#define GPS_USART_IRQ_HANDLER	USART1_IRQHandler
...
#define GPS_USART_IT	USART2
#define APBPERIPHERAL_USART	RCC_APB1Periph_USART2
#define GPS_USART_IRQ_HANDLER	USART2_IRQHandler

#if DFM17_USART_EXT_PORT == 1
// External serial on USART1 (PA9 TX, PA10 RX) - does not conflict with I²C
#define BANK_EXT_USART_TX	GPIOA
#define PIN_EXT_USART_TX	GPIO_PIN_9
#define BANK_EXT_USART_RX	GPIOA
#define PIN_EXT_USART_RX	GPIO_PIN_10
#define EXT_USART		USART1
#define EXT_USART_IRQn		USART1_IRQn
#define EXT_USART_CLK_ENABLE()	__HAL_RCC_USART1_CLK_ENABLE()
#define EXT_USART_CLK_DISABLE()	__HAL_RCC_USART1_CLK_DISABLE()
#elif DFM17_USART_EXT_PORT == 3
// External serial on USART3 (PB10 TX, PB11 RX) - shares pins with I²C
#define BANK_EXT_USART_TX	GPIOB
#define PIN_EXT_USART_TX	GPIO_PIN_10
#define BANK_EXT_USART_RX	GPIOB
#define PIN_EXT_USART_RX	GPIO_PIN_11
...
#define EXT_USART_CLK_DISABLE()	__HAL_RCC_USART3_CLK_DISABLE()
#else
#error DFM17_USART_EXT_PORT must be 1 or 3
#endif
